...
const destinationFolder = "src/lib/types";
const backendName = "../jeffeth-donaldson-blog"

const files = [
  {
    src: path.join(__dirname, `${backendName}/types/generated/contentTypes.d.ts`),
    dest: path.join(__dirname, `./${destinationFolder}/contentTypes.d.ts`),
  },
  {
    src: path.join(__dirname, `${backendName}/types/generated/components.d.ts`),
